...
void SCPrintf::Update() {
	matrix->Update();
	VectorScreenPrintf(0, 0, matrix->transformed, "transformed");
	MatrixScreenPrintf(0, kRowHeight, matrix->TranslateMatrix, "translateMatrix");
	MatrixScreenPrintf(0, kRowHeight * 6, matrix->ScaleMatrix, "scaleMatrix");
}